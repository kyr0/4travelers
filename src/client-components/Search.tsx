...
import { cloudinary } from "../layouts/components/Cloudinary";
  ...
  return (
    <div className="min-h-[45vh]">
      <input
        ...
        placeholder="Schreib hier um zu suchen..."
        type="text"
        name="search"
        value={inputVal}
      ...
      {inputVal.length > 1 && (
        <div className="my-6 text-center">
          Für '{inputVal}' {searchResults?.length && searchResults?.length === 1
            ? " wurde"
            : " wurden"}{" "} {searchResults?.length}
