...
You can always change/withdraw your consent later by clicking on the settings button on the left lower corner of the page.`,
        ...
        privacySettingsText: 'This tool helps you to select and deactivate various tags / trackers / analysis tools used on this website.',
        ...
        categories: {
            ...
            essentialText: 'These tags are required for the basic functions of the website.',
            functionalText: 'These tags enable us to analyze website usage so that we can measure and improve its performance.',
            marketingText: 'Marketing/target cookies are usually used to show you advertisements that meet your interests. When you visit another website, your browser\'s cookie is recognized and selected ads are displayed to you based on the information stored in this cookie (art. 6 par. 1 p. 1 a) GDPR).',
            otherText: 'Within our organization we use other tools for data processing, such as our CRM or our newsletter provider. These are also listed here for informational purposes. However, data is collected only after a certain interaction, for example, when you agree on a demo or subscribe to the newsletter. If you wish to object to data processing by these processors, please contact us.',
        },
        saveButtonText: 'Save',
        moreTitle: '🍪 Privacy Settings',
        moreText: 'This tool helps you to select and deactivate various tags / trackers / analysis tools used on this website.',
        thirdPartyNote: "This is integrated with a third party. If you later decide to change your preferences, please remember to manually clear any previously stored cookies through your browser's privacy settings.",
    },
    'de': {
        activate: 'Aktivieren',
        integration: 'Integration',
...
Sie können diese jederzeit später ändern/widerrufen, indem Sie auf die Schaltfläche Einstellungen in der linken unteren Ecke der Seite klicken.`,
        ...
        privacySettingsText: 'Mit diesem Tool können Sie verschiedene auf dieser Website verwendete Tags / Tracker / Analyse-Tools auswählen und deaktivieren.',
