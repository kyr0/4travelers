...
The use of Cloudflare is based on our legitimate interest in providing our website as free of errors and as secure as possible (Art. 6 para. 1 lit. f DSGVO).`
      ...
      url: {
        de: 'https://www.vgwort.de/hilfsseiten/datenschutz.html',
        en: 'https://www.vgwort.de/hilfsseiten/datenschutz.html',
      },
      description: {
        de: `Die VG WORT setzt ein Tracking-Pixel zur Messung von Zugriffen auf Texten, um die Kopierwahrscheinlichkeit des Textes zu erfassen. Damit partizipieren die Autoren dieser Website an den Ausschüttungen der VG WORT, welche die gesetzliche Vergütung für die Nutzungen urheberrechtlich geschützter Werke gemäß § 53 UrhG sicherstellen. Cookies werden dazu verwendet, um den Nutzer zu identifizieren und ggf. Daten mehrerer Aufrufe von Texten miteinander verknüpfen zu können.`,
        en: `VG WORT uses a tracking pixel to measure access to texts in order to record the probability of copying the text. In this way, the authors of this website participate in the distributions of VG WORT, which ensure the statutory remuneration for the use of copyrighted works in accordance with § 53 UrhG. Cookies are used to identify the user and, if necessary, to link data from several calls of texts with each other.`
      },
      domain: 'vgwort.de',
      category: 'essential',
      consent: true,
      ...
      description: {
        de: 'Google Maps ist ein Online-Kartendienst der Firma Google LLC. Die Erdoberfläche kann als Straßenkarte oder als Luft- oder Satellitenbild betrachtet werden, wobei auch Standorte von Institutionen oder bekannten Objekten angezeigt werden. Die Karten können mit Ortsmarkierungen, Linien und Formen versehen werden. Die Karten können in eigenen Webseiten eingebunden werden.',
        en: 'Google Maps is an online map service provided by Google LLC. The earth\'s surface can be viewed as a street map or as an aerial or satellite image, with locations of institutions or well-known objects also displayed. The maps can be marked with locations, lines and shapes. The maps can be embedded in your own websites.',
      },
      dataCollected: {
        de: [
          "IP-Adresse",
